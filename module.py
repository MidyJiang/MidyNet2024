...
class MidyNet(nn.Module):
    def __init__(self, flags):
        super(MidyNet, self).__init__()
        ...
        self.elu = nn.ELU()
        self.fc_out = nn.Linear(self.flags.hidden_size, self.num_class)
    ...
    def forward(self, input):
        ...
        for i in range(self.flags.days):
            for j in range(self.flags.max_num_text_len):
